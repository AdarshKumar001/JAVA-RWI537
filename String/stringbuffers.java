...
//append:--------------example
       ...
       StringBuffer sb=new StringBuffer();
        System.out.println(sb.capacity());
            ...
            sb.append("Adarsh");
           System.out.println(sb.capacity()); //Adarsh

           sb.append("Adarsh java");
          System.out.println(sb.capacity());  //16

        sb.append("Adarsh javaa");
        System.out.println(sb.capacity()); //34 (16*2)+2
//
//        StringBuffer sb=new StringBuffer("Adarsh  ");
//        System.out.println(sb.append("python")); //Adarsh  python



//length:------------example
//  StringBuffer sb=new StringBuffer("Adarsh");
//        System.out.println(sb.length()); // count length of char =6



//charAt:---------------example
//        StringBuffer sb=new StringBuffer("Adarsh");
//        System.out.println(sb.charAt(3));  // present char on index = r



//delete:---------------example
//        StringBuffer sb=new StringBuffer("Adarsh");
//        System.out.println(sb.delete(0,1)); // delete char=darsh
...
//false because kisi or object ko refer kr rhe hai agar kisi ek ko krte to True aata !
//
